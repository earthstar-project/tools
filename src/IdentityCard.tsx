  ...
  return (
    <div className="bg-blue-50 dark:bg-blue-900 border-2 border-blue-200 dark:border-blue-700 shadow p-3 rounded-lg space-y-3 w-max-prose">
      <div className="flex items-baseline justify-between">
        ...
        />
        {currentIdentity?.address === keypair.address
          ? (
            <button
              className="text-red-500 border border-red-500 text-sm p-1 rounded"
              onClick={() => {
                const isSure = window.confirm(
                  "Are you sure you want to sign out? These credentials will be forgotten.",
                );
