  ...
  return (
    <div className="h-app w-full h-overflow col-auto md:col-span-2">
      ...
      <div className="space-y-2 p-2 max-w-prose">
        <p>
          You need an <b>identity</b>{" "}
          to write data like messages. Identities don't rely on servers, so they
          work offline. You can have as many or as few as you want.
        </p>
        <form
        ...
        >
          <div className="space-y-2 p-2 bg-gray-100 dark:bg-gray-900 rounded border-2 border-gray-200 dark:border-gray-800">
            <label className="font-bold block">
              A four-character shortname, used as a permanent part of your
              address.
            </label>
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                const result = await Crypto.generateAuthorKeypair(
                  e.target.value,
                );
            ...
            <p className="text-sm">
              Don't worry too much about picking a shortname, it's only used as
              a secondary way to identify you. You can change your display name
              whenever you want.
            </p>
          </div>
          ...
          {proposedKeypair
            ? (
              <>
                ...
                <IdentityCard keypair={proposedKeypair} />
                <p className="text-sm text-gray-800 dark:text-gray-200">
                  Make sure to save the generated address and secret someplace
                  safe. Only you have access to it, so it can never be recovered
                  or reset!
                </p>
